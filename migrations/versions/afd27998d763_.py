...
Revision ID: afd27998d763
Revises: d688440af554
Create Date: 2022-06-12 23:21:44.573889
...
revision = 'afd27998d763'
down_revision = 'd688440af554'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('find_venue', sa.Boolean(), nullable=False),
    ...
    sa.Column('facebook_link', sa.String(length=120), nullable=True),
    sa.Column('website_link', sa.String(length=300), nullable=True),
    sa.Column('find_talent', sa.Boolean(), nullable=False),
    sa.Column('seek_description', sa.String(length=500), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    sa.Column('find_talent', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('seek_description', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
    ...
    sa.Column('facebook_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('website_link', sa.VARCHAR(length=300), autoincrement=False, nullable=True),
    sa.Column('find_venue', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('seek_description', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
